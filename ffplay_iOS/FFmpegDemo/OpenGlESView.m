...
- (void)renderWithData:(unsigned char *)data width:(int)width height:(int)height
{
    ...
    //u
    glBindTexture(GL_TEXTURE_2D, _texture_u);
    glTexImage2D(GL_TEXTURE_2D, 0, GL_LUMINANCE, _width / 2, _height / 2, 0, GL_LUMINANCE, GL_UNSIGNED_BYTE, data + _width * _height);
    
    //v
    glBindTexture(GL_TEXTURE_2D, _texture_v);
    glTexImage2D(GL_TEXTURE_2D, 0, GL_LUMINANCE, _width / 2, _height / 2, 0, GL_LUMINANCE, GL_UNSIGNED_BYTE, data + _width * _height * 5 / 4);
